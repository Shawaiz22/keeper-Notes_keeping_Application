...
function Footer(props) {
    return (
        <footer className='container-fluid foot mt-3'>
        <div className="container">
            <br />
            <br />
            <h5 className="text-center">Copyright &copy; Keeper 💡</h5>
            <p className='text-center'>Designed and developed with ❤ by : Shawaiz Ali Siddiqui</p>
            ...
            <a rel="noreferrer" href="https://www.github.com/Shawaiz22" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg"  width="23px" height="21px" viewBox="0 0 32 32" style={{background: 'white', marginLeft:'2px'}}>
            ...
            <a href="https://www.hackerrank.com/shawaizsidd22" target="_blank" rel="noreferrer">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" height="1.5em" width="1.5em" style={{backgroundColor: 'black', marginTop:'9px'}}>
                                    <path fill="#2FC363"
